...
$assunto_da_mensagem_original="Cadastro de Escolas";
$configuracao_da_mensagem_original="Enviado por:\nNOME: ". $_POST["nome"] ."\nCNPJ: $cnpj\nCONTATO: ". $_POST["contato"] ."\nTELEFONE: ". $_POST["telefone"] ."\nCELULAR: ". $_POST["celular"] ."\nENDEREÇO: ". $_POST["endereco"] ."\nBAIRRO: ". $_POST["bairro"] ."\nCIDADE: ". $_POST["cidade"] ."\nEST: ". $_POST["estado"] ."\nCEP: ". $_POST["cep"] ."\nEmail: ". $_POST["email"] ."\nTEMPO DE EXISTÊNCIA: ". $_POST["tempo"] ."\nEnviado em: ". $_POST["date"] ."";
 
//CONFIGURAÇÕES DA MENSAGEM DE RESPOSTA
// CASO $assunto_digitado_pelo_usuario="s" ESSA VARIAVEL RECEBERA AUTOMATICAMENTE A CONFIGURACAO
// "Re: $assunto"
$assunto_da_mensagem_de_resposta = "Cadastro de Escolas - USOLT  United Schools of Language Teaching";
