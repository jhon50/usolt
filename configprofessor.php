...
$assunto_da_mensagem_original="Cadastro de Professor";
$configuracao_da_mensagem_original="Enviado por:\nNOME: $nome\nTELEFONE: $telefone\nCELULAR: $celular\nIDIOMA: $idioma\nIDENTIDADE: $identidade\nCPF: $cpf\nENDEREÇO: $endereco\nBAIRRO: $bairro\nCIDADE: $cidade\nEST:$ estado\nCEP: $cep\nEmail: $email\nEXPERIÊNCIA: $experiencia\nTEMPO DE EXPERIÊNCIA: $tempo\nCERTIFICADOS: $certificados\nFORMAÇÃO: $formacao\nPRETENSÃO SALARIAL: $salario\nVALOR HORA AULA: $valoraula\nVALOR MENSAL: $valormensal\nCOMENTÁRIOS: $comentario\nEnviado em: $date";
 
//CONFIGURAÇÕES DA MENSAGEM DE RESPOSTA
// CASO $assunto_digitado_pelo_usuario="s" ESSA VARIAVEL RECEBERA AUTOMATICAMENTE A CONFIGURACAO
// "Re: $assunto"
$assunto_da_mensagem_de_resposta = "Cadastro de Professor - USOLT  United Schools of Language Teaching";
